...
public class InvestorLoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_investorlogin);
        ...
        db.collection("users") // Replace "users" with your collection name
                ...
                .addOnCompleteListener(task -> {
                    if (task.isSuccessful() && task.getResult() != null && !task.getResult().isEmpty()) {
                        ...
                        Intent intent = new Intent(this, DisplayStartup.class);
